...
-- Script: 061 — Painel: flag tem_substituicao em get_painel_viagens
-- Executar no Supabase Studio > SQL Editor
--
-- Adiciona coluna tem_substituicao (BOOLEAN) à função get_painel_viagens.
-- Retorna true quando a viagem possui ao menos um pedido cancelado
-- (produto substituído pelo admin), permitindo exibir o badge "BO vinculado"
-- no card do painel em tempo real.
-- ================================================================
