...
-- Script: 067 — Painel: nome da unidade de destino + id do agendamento
-- Executar no Supabase Studio > SQL Editor
--
-- Adiciona ao get_painel_viagens:
--   unidade_descarga_nome TEXT  — nome da revenda de destino (exibição no card)
--   agendamento_id        UUID  — id do agendamento ativo (para cancelar ao redirecionar)
-- ================================================================
