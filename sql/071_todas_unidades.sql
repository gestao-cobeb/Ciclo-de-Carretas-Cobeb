...
-- Script: 071 — Permitir admin leitura ver todas as unidades no painel
...
-- 2. Recriar get_painel_viagens incluindo a nova condição
...
RETURNS TABLE (
  ...
  WITH meu_perfil AS (
    SELECT unidade_id, acesso_total, todas_unidades
